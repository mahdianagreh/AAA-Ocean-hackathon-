 ...
 *  is no longer the caveat the backend stands behind), and delegates the
 *  per-caveat styling to the shared CaveatCard so every page renders the
 *  same treatment (Phase 8 Global Rule 2). */
